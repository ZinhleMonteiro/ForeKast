...
/**
 * Created by ZMonteiro on 2017/04/19.
 */
...
import java.io.BufferedReader; //BufferedReader to read the API’s response into a StringBuffer. When we have the complete response, we convert it to a JSONObject object.
...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "c1adf1f6a33b521bd299497be91e18bb"; //API key
    ...
    public static class placeIdTask extends AsyncTask<String, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                ...
                //must I Log.e(LOG_TAG, "Cannot process JSON results", e);
            }
        }
    }
